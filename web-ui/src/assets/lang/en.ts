...
const en = deepMergeMessages(zhHans, {
  ...
  settings: {
    ...
    resourceUpdate: {
      ...
      progress: {
        remoteHeadNotFound: 'Cannot get remote HEAD',
  ...
  backend: {
    ...
    device: {
      windows: {
        ...
        unavailable: {
          ...
          init_failed: 'Windows device initialization failed: {message}',
        },
      },
      mac: {
        available: 'Available',
        unavailable: {
          ...
          port_not_configured: 'MacPlayTools port is not configured. Start the game in PlayCover, then copy the port number from the window title bar [localhost:port] and fill it in the settings.',
          connect_failed: 'Cannot connect to MacPlayTools ({host}:{port}). Make sure the game is running in PlayCover and MaaTools is enabled.',
          init_failed: 'MacPlayTools device initialization failed: {message}',
        },
      },
    },
    task: {
      ...
      gameNotInForeground: 'Game is not in the foreground. Please switch back to the game and try again.',
      gameNotStarted: 'Game is not running. Please start the game first and try again.',
      suspendSwitchToAlbum: 'Task suspended. Please manually switch to the Album page.',
      tabBarNotFound: 'TabBar not found. Refresh failed.',
      requiredButtonNotFound: 'Required button not found. Refresh failed.',
      cardAttributeSwitchNotFound: 'Card attribute switch button not found. Refresh failed.',
      idolSwitchNotFound: 'Idol switch button not found. Refresh failed.',
      startIdolCardCLIP: 'Starting idol card CLIP learning. Will traverse cards along the bottom bar.',
      startSupportCardCLIP: 'Starting support card CLIP learning. Please make sure you are on the support card list page.',
      noEnhancementConfigured: 'No enhancement tiers are configured.',
      clipNotInitialized: 'CLIP service not initialized. Cannot learn idol card CLIP.',
      notOnIdolCardPage: 'Not on the idol card training page. PRODUCT_CARD_SELECTED label not detected.',
      externalPageRecoveryFailed: 'External page recovery failed: returned to home and opened Produce, but no resume dialog matched.',
      produceFinishTimeout: 'Produce finish failed: result chain timed out without returning to home.',
      consecutiveUnknownsExceeded: 'Produce loop: consecutive unrecognized screen threshold exceeded.',
      noHandlerPause: 'Produce loop: no handler available for current page, paused for analysis (phase={phase}, position={position})',
      maxGameplayLoopsExceeded: 'Produce loop: maximum loop count {max_loops} reached.',
      supportCardSelectionFailed: 'Failed to complete support card selection.',
      unknownSupportCardMode: 'Unknown support card formation mode: {mode}',
      idolCardInfoNotFound: 'Unable to retrieve idol card information.',
      trainingInfoCloseButtonNotFound: 'Training info close button not found, unable to infer dismiss point for overlay.',
      candidateListEmpty: 'Candidate list is empty.',
      combatPowerAnchorNotFound: 'Cannot find [総合力合計] anchor point.',
    },
    gameAsset: {
    ...
    adb: {
      ...
      unavailable: 'Android device is unavailable.',
      touchServiceUnavailable: 'Touch action failed: touch service unavailable.',
      reconnectFailed: 'Failed to reconnect to ADB device.',
    },
    gameUtils: {
      modalHeaderTopEmpty: 'Cannot read modal header position: modal is empty',
      modalMissingHeaderBox: 'Modal \'{title}\' is missing header_box, cannot determine stability',
      modalHeaderMissingCoords: 'Modal \'{title}\' header_box is missing y/cy coordinates, cannot determine stability',
      modalSignatureEmpty: 'Cannot build modal signature: modal is empty',
      modalSignatureMissingHeader: 'Modal \'{title}\' is missing header_box, cannot build signature',
      modalHeaderNoCenter: 'Modal \'{title}\' header_box center point cannot be read',
      modalNoActionButtons: 'Modal \'{title}\' has no usable action buttons, cannot build signature',
    },
  },
  config: {
